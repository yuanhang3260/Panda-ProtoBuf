...
void static_init_default_instances_home_hy_Desktop_Projects_ProtoBuf_samples_simple() {
...
void static_init_home_hy_Desktop_Projects_ProtoBuf_samples_simple() {
  static bool already_called = false;
  if (already_called) return;
  already_called = true;

  ::proto::DescriptorsBuilder descriptors_builder(
      "/home/hy/Desktop/Projects/ProtoBuf/samples/simple.proto");
  auto file_dscpt = descriptors_builder.BuildDescriptors();
  CHECK(file_dscpt != nullptr, "static class initialization for "
        "/home/hy/Desktop/Projects/ProtoBuf/samples/simple.proto failed");
  ::proto::MessageFactory::RegisterParsedProtoFile(file_dscpt);

  static_init_default_instances_home_hy_Desktop_Projects_ProtoBuf_samples_simple();
...
// Force static_init_home_hy_Desktop_Projects_ProtoBuf_samples_simple() to be called at initialization time.
struct static_init_forcer_home_hy_Desktop_Projects_ProtoBuf_samples_simple {
  static_init_forcer_home_hy_Desktop_Projects_ProtoBuf_samples_simple() {
    static_init_home_hy_Desktop_Projects_ProtoBuf_samples_simple();
  }
} static_init_forcer_home_hy_Desktop_Projects_ProtoBuf_samples_simple_obj_;
