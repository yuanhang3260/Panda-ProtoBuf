...
void static_init_default_instances_home_hy_Desktop_Projects_ProtoBuf_samples_tiny() {
...
void static_init_home_hy_Desktop_Projects_ProtoBuf_samples_tiny() {
  static bool already_called = false;
  if (already_called) return;
  already_called = true;

  ::proto::DescriptorsBuilder descriptors_builder(
      "/home/hy/Desktop/Projects/ProtoBuf/samples/tiny.proto");
  auto file_dscpt = descriptors_builder.BuildDescriptors();
  CHECK(file_dscpt != nullptr, "static class initialization for "
        "/home/hy/Desktop/Projects/ProtoBuf/samples/tiny.proto failed");
  ::proto::MessageFactory::RegisterParsedProtoFile(file_dscpt);

  static_init_default_instances_home_hy_Desktop_Projects_ProtoBuf_samples_tiny();
  ...
  static const int DogInfo_offsets_[8] = {
...
// Force static_init_home_hy_Desktop_Projects_ProtoBuf_samples_tiny() to be called at initialization time.
struct static_init_forcer_home_hy_Desktop_Projects_ProtoBuf_samples_tiny {
  static_init_forcer_home_hy_Desktop_Projects_ProtoBuf_samples_tiny() {
    static_init_home_hy_Desktop_Projects_ProtoBuf_samples_tiny();
  }
} static_init_forcer_home_hy_Desktop_Projects_ProtoBuf_samples_tiny_obj_;
...
void DogInfo::Print(int indent_num) const {
  ...
  if (has_friend_type()) {
    ...
    std::string enum_value =
        (reinterpret_cast<const proto::EnumDescriptor*>(
            DogInfo_descriptor_->FindFieldByName("friend_type")->type_descriptor()))
