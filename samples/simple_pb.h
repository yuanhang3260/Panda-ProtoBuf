...
class Pet: public ::proto::Message {
 ...
 private:
  ...
  friend void ::static_init_home_hy_Desktop_Projects_ProtoBuf_samples_simple();
  friend void ::static_init_default_instances_home_hy_Desktop_Projects_ProtoBuf_samples_simple();
};
