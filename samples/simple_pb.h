...
class Pet: public ::proto::Message {
 ...
 private:
  ...
  friend void ::static_init_usr_local_google_home_hangyuan_Desktop_test_C___Snoopy_ProtoBuf_samples_simple();
  friend void ::static_init_default_instances_usr_local_google_home_hangyuan_Desktop_test_C___Snoopy_ProtoBuf_samples_simple();
};
